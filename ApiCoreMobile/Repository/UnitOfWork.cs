...
namespace ApiCoreMobile.Repository
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public IgenricRepository<Category> Catrgories => _category ??= new GenericRepository<Category>(_context);
        public IgenricRepository<Mobiles> Mobile => _mobile ??= new GenericRepository<Mobiles>(_context);
        public void Dispose()
        {
            _context.Dispose(); 
